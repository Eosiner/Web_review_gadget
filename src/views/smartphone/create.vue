<script setup>
    ...
    // Definisikan state untuk kolom di tabel smartphones
    const nama = ref("");
    const merk = ref("");
    const harga = ref("");
    const review = ref("");
    ...
    const storeSmartphone = async () => {
        try {
            // Kirim data ke API
            await api.post("/api/smartphones", {
                nama: nama.value,
                merk: merk.value,
                harga: harga.value,
                review: review.value,
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        <form @submit.prevent="storeSmartphone()">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Nama Smartphone</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    v-model="nama"
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Merk Smartphone</label>
                                <input
                                    type="text"
                                    class="form-control"
                                    v-model="merk"
                                    placeholder="Masukkan Merk Smartphone"
                                />
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Harga Smartphone</label>
                                <input
                                    type="number"
                                    class="form-control"
                                    v-model="harga"
                                    placeholder="Masukkan Harga Smartphone"
                                />
                            ...
                            <div class="mb-3">
                                <label class="form-label fw-bold">Review Smartphone</label>
                                <textarea
                                    class="form-control"
                                    v-model="review"
                                    rows="5"
                                    placeholder="Masukkan Review Smartphone"
                                ></textarea>
