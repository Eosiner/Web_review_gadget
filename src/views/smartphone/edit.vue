<script setup>
    ...
    // onMounted
    onMounted(async () => {
        // Fetch detail data smartphone by ID
        await api.get(`/api/smartphones/${route.params.id}`)
            .then(response => {
    ...
    const updateSmartphone = async () => {
        ...
        await api.post(`/api/smartphones/${route.params.id}`, formData)
            .then(() => {
                // Redirect
                router.push({ path: "/smartphones" });
            })
            .catch((error) => {
                    ...
                    <div class="card-body">
                        <form @submit.prevent="updateSmartphone()">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" v-model="nama" placeholder="Nama Smartphone">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" v-model="merk" placeholder="Merk Smartphone">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" v-model="harga" placeholder="Harga Smartphone">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" v-model="review" rows="5" placeholder="Review Smartphone"></textarea>
